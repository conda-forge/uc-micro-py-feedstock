...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uc-micro-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11463&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/uc-micro-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uc-micro-py` can be installed with:

```
conda install uc-micro-py
```

It is possible to list all of the versions of `uc-micro-py` available on your platform with:
